    ...
    <section id="projects" className="py-24 px-6 relative scroll-mt-28">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          {/* Filters */}
          <div className="flex p-1 bg-white/5 rounded-xl border border-white/5 overflow-x-auto max-w-full">
            {['all', 'mobile', 'web', 'fullstack'].map((cat) => (
              <button
                ...
                className={`
                  ...
                  ${filter === cat ? 'bg-white/10 text-white shadow-sm' : 'text-gray-400 hover:text-white'}
                `}
              >
